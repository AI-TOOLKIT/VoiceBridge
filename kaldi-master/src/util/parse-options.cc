//@+zso Modified by Z. Somogyi 01022018
...
//@-zso    delete [] g_program_name;
//@-zso    g_program_name = program_name;
	std::string s(program_name);	//@+zso
	g_program_name = s;	//@+zso
	delete[] program_name;	//@+zso
