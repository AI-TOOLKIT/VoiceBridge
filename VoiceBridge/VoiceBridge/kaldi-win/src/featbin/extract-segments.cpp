...
Based on: Copyright 2009-2011  Microsoft Corporation;  Govivace Inc.
					 2013       Arnab Ghoshal
		  Apache 2.0
...
int ExtractSegments(int argc, char *argv[], fs::ofstream & file_log)
{
  try {
	...
	if(file_log)
		file_log << "Successfully processed " << num_success << " lines out of "
				 << num_lines << " in the segments file. " << "\n";
	else KALDI_LOG << "Successfully processed " << num_success << " lines out of "
		<< num_lines << " in the segments file. " << "\n";
